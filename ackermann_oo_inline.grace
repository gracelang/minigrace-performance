...
method ackermann(m, n) {
    native "js" code ‹
        var opresult3 = var_m["==(1)"]([1], new GraceNum(0));
        if (Grace_isTrue(opresult3)) {
          ...
          lineNumber = 0;
          var opresult6 = var_n["==(1)"]([1], new GraceNum(0));
          setLineNumber(origLineNumber);
          if (Grace_isTrue(opresult6)) {
            setLineNumber(34);    // compilenode num
            origLineNumber = lineNumber;
            lineNumber = 0;
            var diff8 = var_m["-(1)"]([1], new GraceNum(1));
            setLineNumber(origLineNumber);
            // call case 1: outer request
            origLineNumber = lineNumber;
            lineNumber = 0;
            var call7 = var_$module["ackermann(2)"]([2], diff8, new GraceNum(1));
            setLineNumber(origLineNumber);
            if5 = call7;
          } else {
            ...
            origLineNumber = lineNumber;
            lineNumber = 0;
            var diff10 = var_m["-(1)"]([1], new GraceNum(1));
            setLineNumber(origLineNumber);
            origLineNumber = lineNumber;
            lineNumber = 0;
            var diff12 = var_n["-(1)"]([1], new GraceNum(1));
            setLineNumber(origLineNumber);
            // call case 1: outer requestorigLineNumber = lineNumber;
            lineNumber = 0;
            var call11 = var_$module["ackermann(2)"]([2], var_m, diff12);
            setLineNumber(origLineNumber);
            // call case 1: outer request
            origLineNumber = lineNumber;
            lineNumber = 0;
            var call9 = var_$module["ackermann(2)"]([2], diff10, call11);
            setLineNumber(origLineNumber);
            if5 = call9;
          }
          if2 = if5;
