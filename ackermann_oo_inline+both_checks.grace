...
method ackermann(m, n) {
    native "js" code ‹
        ...
        if (opresult3.returnTo) { opresult3.returnTo = undefined; return opresult3; }
        if (Grace_isTrue(opresult3)) {
          ...
          if (sum4.returnTo) { sum4.returnTo = undefined; return sum4; }
          setLineNumber(origLineNumber);
          if2 = sum4;
        } else {
          var if5 = GraceDone;
          ...
          if (opresult6.returnTo) { opresult6.returnTo = undefined; return opresult6; }
          setLineNumber(origLineNumber);
          if (Grace_isTrue(opresult6)) {
            ...
            if (diff8.returnTo) { diff8.returnTo = undefined; return diff8; }
            setLineNumber(origLineNumber);
            ...
            if (call7.returnTo) { call7.returnTo = undefined; return call7; }
            setLineNumber(origLineNumber);
            if5 = call7;
          } else {
            ...
            if (diff10.returnTo) { diff10.returnTo = undefined; return diff10; }
            setLineNumber(origLineNumber);
            origLineNumber = lineNumber;
            lineNumber = 0;
            if (var_n["-(1)"]) var diff12 = var_n["-(1)"]([1], new GraceNum(1)); else throw new GraceExceptionPacket(NoSuchMethodObject, someMethodName);
            if (diff12.returnTo) { diff12.returnTo = undefined; return diff12; }
            setLineNumber(origLineNumber);
            ...
            if (call11.returnTo) { call11.returnTo = undefined; return call11; }
            setLineNumber(origLineNumber);
            // call case 1: outer request
            origLineNumber = lineNumber;
            lineNumber = 0;
            ...
            if (call9.returnTo) { call9.returnTo = undefined; return call9; }
            setLineNumber(origLineNumber);
            if5 = call9;
          }
          if2 = if5;
